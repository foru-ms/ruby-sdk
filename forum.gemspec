...
require_relative "lib/forum/version"
...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Ruby client library for the Forum API"
  spec.description = "The Forum Ruby library provides convenient access to the Forum API from Ruby."
