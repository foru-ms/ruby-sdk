...
describe Forum::Internal::Types::Union do
  class Rectangle < Forum::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Forum::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Forum::Internal::Types::Model
