...
describe Forum::Internal::Types::Model do
  ...
  class ExampleModel < Forum::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Forum::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Forum::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Forum::Internal::Types::Model
