...
describe Forum::Internal::Types::Utils do
  Utils = Forum::Internal::Types::Utils

  module TestUtils
    class M < Forum::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Forum::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Forum::Internal::Types::Model
      literal :type, "B"
      field :only_on_b, String
    end

    module U
      extend Forum::Internal::Types::Union
    ...
    SymbolStringHash = Forum::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Forum::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = Forum::Internal::Types::Array[String]
      ModelArray = -> { Forum::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Forum::Internal::Types::Array[TestUtils::U] }
